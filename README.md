...
```bash
helm repo add course https://nholuongut/microservice.github.io/microservice/charts
helm search course/
```
...
helm3 repo add hc-v3-repo https://nholuongut/microservice.github.io/microservice/hc-v3-repo
helm3 repo update
helm3 repo list
